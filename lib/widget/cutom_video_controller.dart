      ...
      child: Container(
        ...
        child: Row(
          children: <Widget>[
            ...
            if (chewieController != null && chewieController!.isLive)
              const SizedBox()
            else
              _buildProgressBar(),
            if (chewieController != null && chewieController!.isLive)
            ...
            if (chewieController != null && chewieController!.allowMuting)
              _buildMuteButton(controller),
            if (chewieController != null && chewieController!.allowFullScreen)
              _buildExpandButton(),
          ],
        ),
      ),
    ...
    return GestureDetector(
      ...
      child: AnimatedOpacity(
        ...
        child: Container(
          ...
          child: Center(
            child: Icon(
              chewieController != null && chewieController!.isFullScreen
      ...
      onTap: () async {
        ...
        final chosenSpeed = await showModalBottomSheet<double>(
          ...
          builder: (context) => _PlaybackSpeedDialog(
            ...
            selected: _latestValue?.playbackSpeed ?? 0,
          ),
        );
